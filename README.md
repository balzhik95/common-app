...
```console
$ helm repo add petrel-ai https://balzhik95.github.io/common-app/charts
$ helm repo update
$ helm install my-release petrel-ai/common-app --set image.repository=<Hostname of your container registry> --set image.tag=<tag of your container image>
```
